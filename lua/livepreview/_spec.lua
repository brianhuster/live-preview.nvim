...
relative_path = utils.get_relative_path(vim.uv.cwd(), vim.uv.cwd())
assert(relative_path == vim.uv.cwd():sub(2), "should return just fullpath name")
relative_path = utils.get_relative_path("/opt/other/file.lua", "/home/user/project/")
assert(relative_path == "opt/other/file.lua", "should fallback to full path if parent_path not a prefix")
relative_path = utils.get_relative_path("/home/user/dev/project/src/main.lua", "/home/user/dev/project/")
assert(relative_path == "src/main.lua", "should return correct nested relative path")
